    ...
    return (
        <>
            <div className=" flex flex-col justify-center items-center  ">
                <div className='w-full flex justify-center p-[80px]  bg-gradient-to-b from-[#FFFFFF] to-[#F6F8FA] '>
                    <div className=' sm:container flex items-center md:items-start  flex-col p-3 w-full sm:w-[60vw]  '>
                        <h1 className='font-bold text-4xl text-[#034695] '>Contact Us</h1>
                ...
                <div className='inquiry-steps'>
                    <div className='container bg-white text-black flex flex-col items-center '>
                        <div className='steps flex flex-col  items-center text-center w-full p-[80px]'>
                        ...
                        <div className='map relative w-[80vw] mb-[80px]  h-[600px] rounded-[10px] overflow-hidden  shadow-xl text-black'>
